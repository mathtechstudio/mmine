...
// in mmine/test/features/music_player/data/datasources/local_database_data_source_test.dart.
...
class _Fake$TracksTable_1 extends _i1.SmartFake implements _i2.$TracksTable {
  _Fake$TracksTable_1(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$PlaylistsTable_2 extends _i1.SmartFake
    implements _i2.$PlaylistsTable {
  _Fake$PlaylistsTable_2(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$PlaylistTracksTable_3 extends _i1.SmartFake
    implements _i2.$PlaylistTracksTable {
  _Fake$PlaylistTracksTable_3(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}

class _Fake$SettingsTable_4 extends _i1.SmartFake
    implements _i2.$SettingsTable {
  _Fake$SettingsTable_4(Object parent, Invocation parentInvocation)
    : super(parent, parentInvocation);
}
...
class MockAppDatabase extends _i1.Mock implements _i2.AppDatabase {
  ...
  @override
  _i2.$TracksTable get tracks =>
      (super.noSuchMethod(
            Invocation.getter(#tracks),
            returnValue: _Fake$TracksTable_1(this, Invocation.getter(#tracks)),
          )
          as _i2.$TracksTable);

  @override
  _i2.$PlaylistsTable get playlists =>
      (super.noSuchMethod(
            Invocation.getter(#playlists),
            returnValue: _Fake$PlaylistsTable_2(
              this,
              Invocation.getter(#playlists),
            ),
          )
          as _i2.$PlaylistsTable);

  @override
  _i2.$PlaylistTracksTable get playlistTracks =>
      (super.noSuchMethod(
            Invocation.getter(#playlistTracks),
            returnValue: _Fake$PlaylistTracksTable_3(
              this,
              Invocation.getter(#playlistTracks),
            ),
          )
          as _i2.$PlaylistTracksTable);

  @override
  _i2.$SettingsTable get settings =>
      (super.noSuchMethod(
            Invocation.getter(#settings),
            returnValue: _Fake$SettingsTable_4(
              this,
              Invocation.getter(#settings),
            ),
          )
